                    ...
                    : ((cK = b0[aj](cN / 2)),
                        ...
                        cO <= cK
                            ...
                            : cJ <= cO + cM
                                ...
                                : ((i = cO - cK), cO + cM)));
        for (
            var cH = (cO - 1) * cM, cN = b0[ag](cH + cM - 1, cK - 1), cP = [], cL = 0;
            cL < cI + 1 - i;
            cL++
        ) {
            cP[aq](cL);
        ...
        "IMG" == cK[bM] &&
            ((cO = cK[bB + a2]("data-src"))[aI](/(bp.blogspot|googleusercontent)/)
                ? ((cH = b5 ? (M[bQ] && 1 < M[bQ] ? M[bQ] : 1.5) : 1),
                    ...
                    (cH = J(cK[aW], "ratio")
                        ? "w" + cN + "-h" + i + "-c" + au
                        : "s" + (cH = cN < 30 ? (cL < 30 ? cM : cL) : cN) + au),
                    (cO = cO[aI](/(img\/a|proxy\/)/)
                        ? cJ
                            ? cO[bF](0, cJ) + cH
                            : cO + "=" + cH
                        : cO[D](cI[cI[cx] - 2], cH)),
                    cK[bk + a2]("data-src", cO))
                : cO[aI](/(img.youtube|i.ytimg)/) &&
            ...
            cK[bB + a2]("data-pagination") != x
                ? ((cH = cK[bB + a2]("data-posts")),
                        ...
                        if (cH < i) {
                            ...
                            1 != cU.currentPage &&
                                ((i = cJ(
                                    ...
                                    cR[cy](i)),
                                A(cU.pages, 1) ||
                                ((cV = cJ(1, cU.currentPage, "1 . .")), cR[cy](cV));
                            for (var cT = 0; cT < cU.pages[cx]; cT++) {
                                var cV = cJ(cU.pages[cT], cU.currentPage);
                                cR[cy](cV);
                            }
                            A(cU.pages, cS) ||
                                ((cV = cJ(cS, cU.currentPage, ". . " + cS)), cR[cy](cV)),
                                cU.currentPage != cS &&
                                ((cS = cJ(
                                    cU.currentPage + 1,
                                    "",
                    ...
                    (jo[e + "_date"] = function (i) {
                        (i = i.feed.entry[0]),
                            (i = (i = i.published.$t[bc](0, 19) + i.published.$t[bc](23, 29))[
                                D
                            ]("+", "%2B")),
                            (i =
                                aG +
    ...
    jo[ct] = function (cM) {
        ...
        Defer.js(
            ...
            (jo[k + "_" + bs + "_" + cH] = function (cX) {
                ...
                if (0 < c1) {
                    for (
                        var c0 = { title: cJ, posts: [], categories: cZ },
                        cS = cX.feed.entry,
                        cU = 0,
                        cV = 0;
                        cV < cS[cx];
                    ...
                    typeof cX === bq &&
                        0 < c0.posts[cx] &&
                        (cK && (c0.posts = cs(c0.posts)[bF](0, cK)),
                            (cM[be] = cX(c0)[a8]()),
    ...
    bT &&
        ...
        cz[cc + a4](G, function (i) {
            i[ca](),
                bw(aZ, "dark-mode"),
                null !== bC &&
                bC[bk + aS]("theme", J(aZ, "dark-mode") ? "dark" : "light");
        }),
        M[cc + a4](
            bV,
            function () {
            ...
            i[bY](av, cJ),
                ...
                (i[ac] = function () {
                    ...
                    bz(cI, "loading"),
                        ...
                        200 === this[cF] &&
                        "" != this[cl] &&
                        ((cK = an(this[aD][a8]())) && "true" == cK.details.emailSentStatus
                            ? (cI[C](), bz(cI, "send-error"), I(cI, "send-success"))
                            : (bz(cI, "send-success"), I(cI, "send-error")));
                });
        });
    }
    function c(cQ) {
        if (
            (cQ && (aQ[aM + a4](bL, c), aQ[aM + a4](Y, c), aQ[aM + a4](bV, c)),
                Defer.dom(".custom-posts", 1, null, jo[ct], null, { rootMargin: "200%" }),
                0 < H[cx])
        ) {
        ...
        if (null !== cg) {
            if (
                ...
                for (var cM, cW = 0; cW < cI; cW++) {
                    cW == cI - 1
                        ? cg[cy](cL[0])
                        : ((cM = cW == cI - 1 ? cX[cx] - 1 : b0[bu](cX[cx] / cI) * cW),
                            (cM = 0 == cW ? cX[0] : cX[cM][bG]) &&
                            cM[aW][cj + bO](cL[0], cM));
                }
            }
            if (bn && bn != x && ak && null !== cg[bA]) {
                for (
                    var cS = cg[cw]("h2,h3,h4,h5,h6"),
                    cK = aQ[bJ]("div"),
                    cQ = cg[bv](n),
                    cO = [],
                    cW = 0;
                ...
                null === cQ ? (cQ = cg[bA]) : cQ[bG] && (cQ = cQ[bG]),
                    0 < cO[cx] &&
                    ((cK[be] = ak(cO)[a8]()), cQ && cQ[aW][cj + bO](cK, cQ));
            }
        }
        cA ||
            (aR &&
                (typeof adsbygoogle === cE && (adsbygoogle = []),
                    Defer.js(
                        ce +
                ...
                v != x &&
                Defer.js(
                    ce + "www.googletagmanager.com/gtag/js?id=" + v,
                    bE,
                    100,
                    function () {
                        function i() {
